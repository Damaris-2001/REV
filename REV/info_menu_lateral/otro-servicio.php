    ...
    <div id="tab2" class="tab-slider-body">
        <div class="wrapper-add-info">
            ...
            <div class="card-add card-two">
                <h3>ASISTENCIA</h3>
                <div class="servicios__items">
                    <p class="servicios__features">Asistencia técnica y comercial para la implantación de empresas en el
                        mercado LATAM.</p>
                </div>
                <input type="button" value="Mas informacion" class="btn-actions btn-add card_btn">
            </div>
            ...
            <div class="card-add card-three">
                <h3>INSTALACIONES</h3>
                <div class="servicios__items">
                    <p class="servicios__features">Servicios de instalación y puesta en marcha de equipamiento en
                        activos de energía renovable.</p>
                </div>
                <input type="button" value="Mas informacion" class="btn-actions btn-add card_btn">
            </div>
        </div>
